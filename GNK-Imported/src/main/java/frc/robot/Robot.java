...
public class Robot extends TimedRobot {
    ...
    public void autonomousPeriodic() {
        CommandScheduler.getInstance().run();
        Constants.spark1.setIdleMode(IdleMode.kCoast);
        Constants.spark2.setIdleMode(IdleMode.kCoast);
        Constants.spark3.setIdleMode(IdleMode.kCoast);
        Constants.spark4.setIdleMode(IdleMode.kCoast);
        Constants.spark5.setIdleMode(IdleMode.kCoast);
        Constants.spark6.setIdleMode(IdleMode.kCoast);
    }
